    ...
    return (
      <div className="flex flex-col min-h-screen">
        <div className="flex items-center gap-3 px-5 py-4 bg-[#020c1a]/75 backdrop-blur-md border-b border-white/8">
          ...
          <h1 className="font-bold text-[#e8f4ff] text-base">
            Find the Country
          </h1>
        </div>
          ...
          <div className="w-full max-w-sm bg-[#061428]/90 backdrop-blur-2xl border border-white/10 rounded-3xl p-7 shadow-2xl">
            <div className="flex flex-col items-center gap-5">
              ...
              <div className="text-center">
                <h2 className="text-2xl font-black text-[#e8f4ff]">
                  Find the Country
                </h2>
              ...
              <div className="w-full space-y-5">
                <div>
                  <p className="text-[11px] font-bold text-[#6b9ab8] uppercase tracking-widest mb-2">
                    Region
                  </p>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-[11px] font-bold text-[#6b9ab8] uppercase tracking-widest">
                      Questions
                    </p>
                ...
                <div className="flex items-center gap-3 bg-primary/8 border border-primary/15 rounded-xl px-4 py-3">
                  ...
                  <p className="text-xs text-[#a0c8e0] font-medium leading-relaxed">
                    Answer in <strong className="text-[#e8f4ff]">3 s</strong>{" "}
                    for <strong className="text-primary">4 pts</strong> · slower
                    earns fewer · {TIME_LIMIT}s limit
                  </p>
                </div>
              </div>
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex items-center gap-3 max-w-3xl mx-auto">
          ...
          <div className="flex-1 text-center">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              />
              <span className="text-xl font-black text-[#e8f4ff]">
                {current.name}
              </span>
            </div>
          </div>
          <div className="w-14 shrink-0 flex flex-col items-center">
            <span className="text-[10px] text-[#6b9ab8] font-semibold uppercase">
              pts
            </span>
      ...
      >
        ...
        {feedbackOk === false && (
          <>
            <XCircle className="w-4 h-4 shrink-0" /> It was{" "}
            <strong className="ml-1">{current.name}</strong>
          </>
        )}
      </div>
    </div>
